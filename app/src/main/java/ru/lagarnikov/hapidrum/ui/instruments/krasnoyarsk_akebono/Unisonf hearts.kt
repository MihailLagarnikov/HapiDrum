package ru.lagarnikov.hapidrum.ui.instruments.krasnoyarsk_akebono
    ...
    override fun getInstrumentParams(): ArrayList<InstrumentKeyParams> {
        return arrayListOf(
            InstrumentKeyParams(
                ...
                button_a,
                hapi_drum_a,
                getFilePath(UNISON_OF_HEARTS_SOUNDS_.get(0).fileLocalName, UNISON_OF_HEARTS_SOUNDS_.get(0).fileExtension)
            ),
            InstrumentKeyParams(
                KeyValues.B,
                button_b,
                hapi_drum_b,
                getFilePath(UNISON_OF_HEARTS_SOUNDS_.get(1).fileLocalName, UNISON_OF_HEARTS_SOUNDS_.get(1).fileExtension)
            ),
            InstrumentKeyParams(
                KeyValues.C,
                button_c,
                hapi_drum_c,
                getFilePath(UNISON_OF_HEARTS_SOUNDS_.get(2).fileLocalName, UNISON_OF_HEARTS_SOUNDS_.get(2).fileExtension)
            ),
            InstrumentKeyParams(
                KeyValues.D,
                button_d,
                hapi_drum_d,
                getFilePath(UNISON_OF_HEARTS_SOUNDS_.get(3).fileLocalName, UNISON_OF_HEARTS_SOUNDS_.get(3).fileExtension)
            ),
            InstrumentKeyParams(
                KeyValues.E,
                button_e,
                hapi_drum_e,
                getFilePath(UNISON_OF_HEARTS_SOUNDS_.get(4).fileLocalName, UNISON_OF_HEARTS_SOUNDS_.get(4).fileExtension)
            ),
            InstrumentKeyParams(
                KeyValues.F,
                button_f,
                hapi_drum_f,
                getFilePath(UNISON_OF_HEARTS_SOUNDS_.get(5).fileLocalName, UNISON_OF_HEARTS_SOUNDS_.get(5).fileExtension)
            ),
            InstrumentKeyParams(
                KeyValues.G,
                button_g,
                hapi_drum_g,
                getFilePath(UNISON_OF_HEARTS_SOUNDS_.get(6).fileLocalName, UNISON_OF_HEARTS_SOUNDS_.get(6).fileExtension)
            ),
            InstrumentKeyParams(
                KeyValues.H,
                button_h,
                hapi_drum_h,
                getFilePath(UNISON_OF_HEARTS_SOUNDS_.get(7).fileLocalName, UNISON_OF_HEARTS_SOUNDS_.get(7).fileExtension)
            )
        )
    }
}